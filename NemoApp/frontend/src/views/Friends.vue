      ...
      <div v-if="selectedFriend" class="profile-details">
        <div class="profile-header">
          ...
          <div class="profile-basic-info">
            ...
            <Tag 
              :value="selectedFriend.isOnline ? 'Online' : 'Offline'"
              :severity="selectedFriend.isOnline ? 'success' : 'secondary'"
            />
          </div>
        </div>
        ...
        <div class="profile-sections">
          ...
          <div class="section">
            <h4><i class="pi pi-briefcase"></i> Experience</h4>
            <p>{{ selectedFriend.experience }} years</p>
          </div>
